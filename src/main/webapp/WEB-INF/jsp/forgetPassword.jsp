...
<head>
    ...
    <link href="../../static/regist/pictureYanZheng/css/jquery.idcode.css" type="text/css" rel="stylesheet">
    <link href="../../static/regist/css/style.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="../../static/regist/js/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="../../static/regist/forgetPassword.js"></script>
</head>
