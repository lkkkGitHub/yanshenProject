...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="../../static/person/css/css.css">
    <script src="../../static/person/js/jquery-1.8.3.min.js"></script>
    <script src="../../static/person/index2.js"></script>
    <link rel="stylesheet" type="text/css"
          href="../../static/person/css/center.css">

    <!--城市联动-->
    <link rel="stylesheet" type="text/css"
          href="../../static/person/city/city.css">
    <script src="../../static/person/city/Popt.js"></script>
    <script src="../../static/person/city/cityJson.js"></script>
    <script src="../../static/person/citySet.js"></script>
    <!-- 上传头像 -->
    <script src="../../static/person/headImage/head/jquery.min.js"></script>

    <link rel="stylesheet" type="text/css"
          href="../../static/person/headImage/css/bootstrap.min.css">
    <link href="../../static/person/headImage/head/cropper.min.css"
          rel="stylesheet">
    <link href="../../static/person/headImage/head/sitelogo.css"
          rel="stylesheet">
    <link rel="stylesheet" type="text/css"
          href="../../static/person/headImage/css/font-awesome.min.css">

    <script src="../../static/person/headImage/head/bootstrap.min.js"></script>
    <script src="../../static/person/headImage/head/cropper.js"></script>
    <script src="../../static/person/headImage/head/sitelogo.js"></script>
    <script src="../../static/person/headImage/head/html2canvas.js"></script>
    <!-- 生日插件 -->
    <script type="text/javascript"
            src="../../static/person/birthday/jedate/jedate.js"></script>
    <style>
        .datainp {
            width: 200px;
            height: 30px;
    ...
    <div class="centers_ml">
        ...
        <div class="centers_listm" style="width: 210px;">
            <div class="centers_listm_one" style="width: 210px;">
                <img src="../../static/person/images/zshy.png"/> <em>会员中心</em>
            </div>
            <!--一条开始-->
            <div class="centers_listm_one_in" style="width: 210px;">
                <img src="../../static/person/images/shezhi.png"/> <em>资料管理</em>
                <b></b>
            </div>
            ...
            <!--一条开始-->
            <div class="centers_listm_one_in" style="width: 210px;">
                <img src="../../static/person/images/suo.png"/> <em>账户安全</em> <b></b>
            </div>
            ...
            <!--一条开始-->
            <div class="centers_listm_one_in" style="width: 210px;">
                <img src="../../static/person/images/myfridend.png"/> <em>我的好友</em>
                <b></b>
            </div>
        ...
        <div class="public_m1">
            ...
            <div class="zp_nrm">
                ...
                <div class="zp_nrm_l">
                    ...
                    <script src="/static/person/headImage/head/html2canvas.min.js" type="text/javascript"
                    ...
                    <form action="/User/changUserInfo" method="post" id="form1">
                        ...
                        <p id="userEmail">
                            <em>邮箱：</em><i>${user.email}</i> <a href="#fst1"
                                                                style="text-decoration: none;">立即修改</a> <input
                                type="text"
