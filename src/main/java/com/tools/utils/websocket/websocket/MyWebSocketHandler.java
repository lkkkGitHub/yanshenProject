...
public class MyWebSocketHandler implements WebSocketHandler {
    ...
    private static ConcurrentHashMap<String, Set<WebSocketSession>> userSocketSessionMap = new ConcurrentHashMap<>();
    ...
    public void handleMessage(WebSocketSession session, WebSocketMessage<?> message) throws Exception {
        ...
        sendMessageToUser(msg.getTo(), new TextMessage(msg.toString()));
    }
    ...
    private void removeSocket(WebSocketSession session) {
        // 移除Socket会话
